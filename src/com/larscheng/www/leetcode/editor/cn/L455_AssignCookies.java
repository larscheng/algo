...
// 
//
// Related Topics 贪心 数组 双指针 排序 👍 818 👎 0
...
public class L455_AssignCookies{
  ...
  public static void main(String[] args) {
       Solution solution = new L455_AssignCookies().new Solution();
...
class Solution {
    /**
     * 两数组排序，双指针遍历，满足s[p2] >= g[p1]记一次有效分发
     * O(Max(nlogn,mlogm))/O(Max(logn,logm))
     */
