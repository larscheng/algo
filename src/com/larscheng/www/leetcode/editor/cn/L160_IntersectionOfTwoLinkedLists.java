...
//
// Related Topics 哈希表 链表 双指针 👍 2299 👎 0
...
public class L160_IntersectionOfTwoLinkedLists{
  ...
  public static void main(String[] args) {
       Solution solution = new L160_IntersectionOfTwoLinkedLists().new Solution();
...
public class Solution {
    /**
     定义两个指针a,b
     当 a 指针将 A 链表遍历完后，重定位到链表 B 的头结点，b 指针将 B 链表遍历完后，重定位到链表 A 的头结点, 然后继续遍历至相交点。
