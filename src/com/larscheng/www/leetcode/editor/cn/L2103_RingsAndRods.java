...
public class L2103_RingsAndRods{
      
  public static void main(String[] args) {
       Solution solution = new L2103_RingsAndRods().new Solution();
    ...
    class Solution1 {
        public int countPoints(String rings) {
            ...
            for (int i = 0; i < rings.length()-1; i+=2) {
                ...
                Set<Character> orDefault = map.getOrDefault(num, new HashSet<>());
                orDefault.add(color);
                if (orDefault.size()==3){
                    orDefault.add('N');
                    count++;
